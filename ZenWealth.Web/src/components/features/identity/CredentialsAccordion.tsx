...
const CredentialsAccordion = () => {
    ...
    // Trigger the slide-up animation on component mount
    React.useEffect(() => {
        const timer = setTimeout(() => {
            setIsVisible(true);
        }, 500); // Delay the animation by 500ms for a more polished feel
    ...
    return (
        <div className={`fixed bottom-3 sm:left-4 z-50 w-full max-w-md px-3 transition-transform duration-700 ease-out ${
            isVisible ? "translate-y-0" : "translate-y-[110%]"
        }`}>
            <Alert className="border-neutral-600 bg-neutral-900 backdrop-blur-sm">
...
export default CredentialsAccordion;