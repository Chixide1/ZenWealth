    ...
    return (
        <Card className={cn("bg-primary/[0.125] min-w-60 md:min-w-36 md:w-full p-5 rounded-2xl border-0", className)}>
            ...
            <CardContent className="p-0">
                <CardTitle className="text-neutral-400 text-xs font-semibold w-1/2">Total {dataTitle}</CardTitle>
            ...
            <CardFooter className="p-0 flex items-center">
                <h6 className="text-neutral-400 text-xs font-semibold mr-2">Last Month:</h6>
