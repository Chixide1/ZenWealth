...
public partial class TransactionServiceTests
{
    ...
    public async Task GetRecentTransactions_ReturnsRecentTransactions_WhenRepositoryReturnsData()
    {
        ...
        var allTransactions = new List<TransactionDto>
        {
            new()
            {
                Id = 1, AccountName = "Checking", Amount = 50.25m, Date = new DateOnly(2025, 5, 1),
                Category = "FOOD_AND_DRINK"
            },
            new()
            {
                Id = 2, AccountName = "Credit Card", Amount = 120.99m, Date = new DateOnly(2025, 4, 28),
                Category = "SHOPPING"
            }
        };
        ...
        var incomeTransactions = new List<TransactionDto>
        {
            new()
            {
                Id = 3, AccountName = "Checking", Amount = -1500m, Date = new DateOnly(2025, 5, 1), Category = "INCOME"
            },
            new()
            {
                Id = 4, AccountName = "Savings", Amount = -500m, Date = new DateOnly(2025, 4, 15), Category = "INCOME"
            }
        };
        ...
        var expenditureTransactions = new List<TransactionDto>
        {
            new()
            {
                Id = 5, AccountName = "Credit Card", Amount = 75.50m, Date = new DateOnly(2025, 5, 2),
                Category = "ENTERTAINMENT"
            },
            new()
            {
                Id = 6, AccountName = "Checking", Amount = 30m, Date = new DateOnly(2025, 4, 30),
